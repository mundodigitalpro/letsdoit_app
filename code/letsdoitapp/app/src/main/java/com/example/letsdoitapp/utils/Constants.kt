...
object Constants {
    ...
    const val PAYPAL_CLIENT_ID = "AaTDlKfUmdpUijKkNikecUQQSYzgMAwRlUqRUh5Nduhjx4sGodHT_P_YQYfM2H1Y6he38L9KGrUXZa2v"


    const val APP = "Let's Do iT"
    const val EMAIL = "mundodigital.pro@gmail.com"
    const val AUTHOR = "Jose Jordan\n"
    const val CENTRE = "IES - Trassierra - Córdoba\n"
